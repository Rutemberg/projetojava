...
public class FornecedorController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<Fornecedor>> encontrarFornecedorPorNome(@RequestParam String nome) {
        return new ResponseEntity<>(fornecedorService.encontrarFornecedorPorNome(nome), HttpStatus.OK);
